  ...
  return (
    <div className="stack">
      ...
      <Card>
        ...
        <div className="card-pad">
          <Callout icon="i">
            Die Standardtexte der E-Mails stehen unter <strong>Vorlagen</strong> in der Seitenleiste. Sie gelten
            für alle Projekte; Absender und Vorlaufzeit bleiben projektbezogen.
          </Callout>
        </div>
      </Card>
