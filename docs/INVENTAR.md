...
wählbar. Weiter: **Schritt einfügen**, Antwort einer Entscheidung
...
| Planliste: Haken „Pläne einzeln durch den Planlauf führen“ ist ausgegraut – „Es bestehen bereits Planläufe. Die Pläne lassen sich nur noch nachträglich einzeln weiterführen.“ bzw. „Die Pläne laufen bereits einzeln – eine Rückkehr zur Bündelung ist nicht vorgesehen.“ | Kein Fehler: Sobald das Verzeichnis oder einer seiner Pläne einen Lauf hat, ist die Wahl gesperrt (`modusGesperrt` in `Plaene.tsx`). Richtung „einzeln“ geht es weiter über „Alle Pläne einzeln weiterführen …“ bzw. „Aus dem Verzeichnislauf herauslösen …“; eine Rückkehr zur Bündelung ist nicht umgesetzt. |
